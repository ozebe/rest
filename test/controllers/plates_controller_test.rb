...
class PlatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plate" do
    assert_difference('Plate.count') do
      post plates_url, params: { plate: { description: @plate.description, price: @plate.price, timeprep: @plate.timeprep } }
    end
  ...
  test "should update plate" do
    patch plate_url(@plate), params: { plate: { description: @plate.description, price: @plate.price, timeprep: @plate.timeprep } }
